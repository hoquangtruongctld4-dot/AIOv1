...
namespace subphimv1.Services
{
    public class SrtTranslationService
    {
        ...
        private async Task<string> TranslateWithChutesAIAsync(string inputText, CancellationToken token, string genre, string lang)
        {
        ...
        private async Task<string> TranslateWithGeminiAsync(string inputText, CancellationToken token, string genre, string lang)
        {
        ...
        private async Task<string> TranslateWithChatGPTAsync(string inputText, CancellationToken token, string genre, string lang)
        {
