...
namespace subphimv1.ViewModels
{
    public class UserViewModel : INotifyPropertyChanged
    {
        public async Task RefreshProfileAsync()
        {
            ...
            {
                // Logic xử lý lỗi có thể được thêm ở đây nếu cần,
                // ví dụ như gọi Logout nếu token hết hạn.
                // Hiện tại, HeartbeatTick đã xử lý việc này.
            }
        }
        public string UsageInfoString
        {
            get
            {
                ...
                // Đối với user Free, hiển thị cả hai thông tin
                if (Tier == "Free")
                {
                ...
                // Đối với user trả phí, chỉ hiển thị thông tin ký tự AIO
                else
                {
        ...
        public string AioCharacterInfo => IsLoggedIn ? $"Server: {AioCharactersUsedToday:N0} / {(AioCharacterLimit <= 0 ? "N/A" : AioCharacterLimit.ToString("N0"))} ký tự" : "Server: N/A";
        ...
        public string SrtLimitInfo => $"SRT: {SrtLinesUsedToday}/{DailySrtLineLimit}";
        ...
        // <<< THÊM MỚI: Thuộc tính AllowedApiAccess để lưu quyền API >>>
        ...
        public int RemainingRequests
        {
            ...
            set
            {
                ...
                if (_remainingRequests != value)
                {
                    ...
                    OnPropertyChanged();
                    OnPropertyChanged(nameof(UsageInfoString)); // Thêm
                }
            }
        }
